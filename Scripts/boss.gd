...
@onready var hp_bar = $boss_HP_bar
@onready var agent = $NavigationAgent2D

var stop_distance = Global.stop_distance + 60
var detect_distance = Global.detect_distance + 300
var player = null
...
func _physics_process(_delta):
	...
	var target_pos = player.global_position + offset_dir * stop_distance
